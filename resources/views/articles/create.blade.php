                ...
                <form method="POST" action="{{ route('articles.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="content" id="content" rows="8"
                            class="border-gray-300 rounded-md shadow-sm focus:border-primary-400 focus:ring focus:ring-primary-200 focus:ring-opacity-50 transition w-full mt-1">{{ old('content') }}</textarea>
                        @error('content')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="thumbnail" class="block font-medium text-sm text-gray-700">Thumbnail (opsional)</label>
