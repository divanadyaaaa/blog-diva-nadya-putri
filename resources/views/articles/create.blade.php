                ...
                <form method="POST" action="{{ route('articles.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea name="content" id="content" rows="8"
                            class="border-gray-200 rounded-xl shadow-sm focus:border-primary-400 focus:ring focus:ring-primary-100 focus:ring-opacity-50 transition w-full">{{ old('content') }}</textarea>
                        @error('content')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-5">
                        <label for="thumbnail" class="block font-medium text-sm text-gray-700 mb-1.5">Thumbnail (opsional)</label>
